...
from .gps_opt import GPS_PointCloudOptimizer
...
class GlobalAlignerMode(Enum):
    ...
    GPSInformedOptimizer = "GPSInformedOptimizer"
...
def global_aligner(dust3r_output, device, mode=GlobalAlignerMode.PointCloudOptimizer, **optim_kw):
    ...
    elif mode == GlobalAlignerMode.GPSInformedOptimizer:
        net = GPS_PointCloudOptimizer(view1, view2, pred1, pred2, **optim_kw).to(device)
    else:
